 ...
 * @returns {Promise<Array>} 处理后的分类信息列表
 */
...
/**
 * 增：新增分类信息
 * @param {Object} categoryData - 分类信息数据对象（包含所有需要插入的字段）
 ...
 * @param {Object} updateData - 要更新的分类信息数据（可选字段）
 ...
 * 删：根据分类信息ID删除分类信息
 * @param {number} id - 分类信息ID
 * @param {Object} deleteData - 要删除的分类信息数据
